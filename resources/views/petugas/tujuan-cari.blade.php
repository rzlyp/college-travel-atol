...
<div class="content">
    <div class="container-fluid">
        <div class="row" style="padding-bottom: 36px;">
            ...
            <div class="col-md-4">
            <form method="post" action="/petugas/tujuan/search" style="margin-top: 24px" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                       ...
                       <select name="cat" class="form-control">
                           ...
                           <option value="nama">Nama Tujuan</option>
                       </select>
                    </div>
                    <div class="form-group">
